...
next.js app use react hooks and woocommerce API as backend as store serveces
...
**Client:** React.js, Next.jd, TailwindCSS, Sass

**Server:** Wordpress Woocommerce API, Node.js hooks
