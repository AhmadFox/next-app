    ...
    <div className="mb-3">
      ...
      <div className="relative w-full border-none">
        <select
          ...
          value={country}
          name="country"
          className="bg-white border border-gray-500 text-gray-500 appearance-none inline-block py-3 pl-3 pr-8 rounded-md leading-tight w-full focus:ring-2 focus:ring-teal-600 focus:ring-opacity-20"
          id={inputId}
        >
